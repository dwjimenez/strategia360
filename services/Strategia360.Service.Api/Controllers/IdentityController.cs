...
namespace DFast.Seguridad.Api.Controllers;
...
public class IdentityController : ControllerBase
{
    ...
    public IdentityController(IIdentityService identityService, IRegistroService registroService    )
    {
    ...
    public async Task<IActionResult> SignIn(SignIn command)
         => Ok(await _identityService.SignInAsync(command.Key, command.Password, command.Sistema, command.Estacion, command.ValidarActivos));
